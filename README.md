...
필요해서 만들고, 궁금해서 만들고, 가끔은 그냥 만들어 보고 싶어서 만든 **개인 프로그램·유틸리티·실험작 아카이브**입니다.
...
새 프로그램이 생기면 `projects/<project-name>/` 아래에 독립적으로 추가합니다. 각 프로젝트는 자체 README와 필요한 이미지·자료를 함께 보관합니다.
